...
class salt::master (
  ...
  $master_syndic_master_port              = $salt::params::master_syndic_master_port,
  $master_syndic_pidfile                  = $salt::params::master_syndic_pidfile,
  $master_syndic_log_file                 = $salt::params::master_syndic_log_file,
