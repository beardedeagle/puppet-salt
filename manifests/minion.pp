...
class salt::minion (
  ...
  $minion_include                     = $salt::params::minion_include,
  ...
  $minion_test_foo                    = $salt::params::minion_test_foo,
  $minion_test_bar                    = $salt::params::minion_test_bar,
  $minion_test_baz                    = $salt::params::minion_test_baz,
